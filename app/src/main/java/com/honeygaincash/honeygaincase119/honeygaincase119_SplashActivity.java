...
public class honeygaincase119_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase119_splash);
    ...
    void datafromlink() {
        new AsyncTask< Void, Void, String >() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/a8d3a85e37/ads.txt";
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                honeygaincase119_SplashActivity.this.startActivity(new Intent(honeygaincase119_SplashActivity.this, honeygaincase119_start_page.class));
